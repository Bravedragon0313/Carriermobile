...
/* harmony import */ var pages_pages_module_guard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! pages/pages.module.guard */ "./src/pages/pages.module.guard.ts");
/* harmony import */ var _info_info_module_guard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./info/info.module.guard */ "./src/app/info/info.module.guard.ts");
...
var routes = [
    {
        ...
        loadChildren: function () {
            return __webpack_require__.e(/*! import() | info-info-module */ "info-info-module").then(__webpack_require__.bind(null, /*! ./info/info.module */ "./src/app/info/info.module.ts")).then(function (m) { return m.InfoPageModule; });
        },
        canLoad: [_info_info_module_guard__WEBPACK_IMPORTED_MODULE_4__["InfoModuleGuard"]],
    },
    {
        path: '',
        loadChildren: function () {
        ...
        canLoad: [pages_pages_module_guard__WEBPACK_IMPORTED_MODULE_3__["PagesModuleGuard"]],
    },
    {
        path: '**',
        pathMatch: 'full',
...
var AppRoutingModule = (function () {
    ...
    AppRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [pages_pages_module_guard__WEBPACK_IMPORTED_MODULE_3__["PagesModuleGuard"], _info_info_module_guard__WEBPACK_IMPORTED_MODULE_4__["InfoModuleGuard"]],
        })
    ], AppRoutingModule);
...
/* harmony import */ var _ionic_native_mixpanel_ngx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @ionic-native/mixpanel/ngx */ "../../node_modules/@ionic-native/mixpanel/ngx/index.js");
...
/* harmony import */ var _modules_client_common_angular2_routers_device_router_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @modules/client.common.angular2/routers/device-router.service */ "../common-angular/src/routers/device-router.service.ts");
...
var AppComponent = (function () {
    function AppComponent(platform, statusBar, splashScreen, ga, mixpanel, network, globalization, device, _langTranslator, store, router, deviceRouter) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.platform.ready().then(function () {
            if (!_this.store.deviceId) {
                _this._registerDevice();
            }
            _this.networkWatch();
            _this._setupLangTranslator();
    ...
    AppComponent.prototype.startGoogleAnalytics = function () {
        ...
        setTimeout(function () {
            _this.ga
                .startTrackerWithId(_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].GOOGLE_ANALYTICS_API_KEY, 30)
                .then(function () {
    ...
    AppComponent.prototype.networkWatch = function () {
        var _this = this;
        var disconnectSubscription = this.network
            .onDisconnect()
            .subscribe(function () {
            _this.store.noInternet = 'noInternet';
            _this.router.navigateByUrl('info/no-internet', {
    ...
    AppComponent.prototype.startMixpanel = function () {
        var _this = this;
        this.mixpanel.init(_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].MIXPANEL_API_KEY).then(function () {
            console.log('Mixpanel is ready now!');
            _this.mixpanel.track('App Booted');
        });
    };
    Object.defineProperty(AppComponent.prototype, "showInformationPage", {
        get: function () {
    ...
    AppComponent.prototype._setupLangTranslator = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var lang, langs, browserLang, _a;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        this.defaultLanguage = _environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"]['DEFAULT_LANGUAGE'];
                        console.log('this.defaultLanguage');
                        console.log(this.defaultLanguage);
                        lang = localStorage.getItem('_language') || null;
                        langs = { he: 'he', ru: 'ru', bg: 'bg', en: 'en', es: 'es' };
                    ...
                    case 1:
                        ...
                        return [4, this.globalization.getPreferredLanguage()];
                    case 2:
                        _a = (_b.sent()).value;
                        return [3, 4];
                    case 3:
                        _a = this._langTranslator.getBrowserLang();
                        _b.label = 4;
                    case 4:
                        browserLang = _a;
    ...
    AppComponent.prototype.deviceCreateObject = function () {
        ...
        if (!this.device.platform || this.device.platform === 'browser') {
            return {
                ...
                language: language,
                type: 'browser',
                uuid: _environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"]['FAKE_UUID'],
            };
        }
        return {
            channelId: null,
    ...
    AppComponent.ctorParameters = function () { return [
        ...
        { type: _ionic_native_mixpanel_ngx__WEBPACK_IMPORTED_MODULE_5__["Mixpanel"] },
        ...
        { type: _modules_client_common_angular2_routers_device_router_service__WEBPACK_IMPORTED_MODULE_13__["DeviceRouter"] }
    ]; };
    AppComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_12__["Platform"],
            ...
            _ionic_native_mixpanel_ngx__WEBPACK_IMPORTED_MODULE_5__["Mixpanel"],
            ...
            _modules_client_common_angular2_routers_device_router_service__WEBPACK_IMPORTED_MODULE_13__["DeviceRouter"]])
    ], AppComponent);
    return AppComponent;
}());
...
/*!*******************************!*\
  !*** ./src/app/app.module.ts ***!
  \*******************************/
/*! exports provided: AppModule, HttpLoaderFactory, googleMapsLoaderFactory, maintenanceFactory, serverConnectionFactory */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _ionic_native_mixpanel_ngx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ionic-native/mixpanel/ngx */ "../../node_modules/@ionic-native/mixpanel/ngx/index.js");
...
/* harmony import */ var _modules_client_common_angular2_common_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @modules/client.common.angular2/common.module */ "../common-angular/src/common.module.ts");
...
/* harmony import */ var _graphql_apollo_config__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../graphql/apollo.config */ "./src/graphql/apollo.config.ts");
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../environments/environment */ "./src/environments/environment.ts");
/* harmony import */ var _modules_client_common_angular2_services_googleMapsLoader__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @modules/client.common.angular2/services/googleMapsLoader */ "../common-angular/src/services/googleMapsLoader.ts");
/* harmony import */ var _services_carriers_orders_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../services/carriers-orders.service */ "./src/services/carriers-orders.service.ts");
/* harmony import */ var _modules_client_common_angular2_services_maintenance_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @modules/client.common.angular2/services/maintenance.service */ "../common-angular/src/services/maintenance.service.ts");
/* harmony import */ var _ionic_native_vibration_ngx__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @ionic-native/vibration/ngx */ "../../node_modules/@ionic-native/vibration/ngx/index.js");
/* harmony import */ var _ionic_native_local_notifications_ngx__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @ionic-native/local-notifications/ngx */ "../../node_modules/@ionic-native/local-notifications/ngx/index.js");
/* harmony import */ var _modules_client_common_angular2_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @modules/client.common.angular2/pipes/pipes.module */ "../common-angular/src/pipes/pipes.module.ts");
/* harmony import */ var _services_store_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../services/store.service */ "./src/services/store.service.ts");
/* harmony import */ var _modules_client_common_angular2_services_server_connection_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! @modules/client.common.angular2/services/server-connection.service */ "../common-angular/src/services/server-connection.service.ts");
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @ionic/angular */ "./node_modules/@ionic/angular/fesm5/ionic-angular.js");
...
/* harmony import */ var components_menu_menu_module__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! components/menu/menu.module */ "./src/components/menu/menu.module.ts");
...
var AppModule = (function () {
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_28__["AppComponent"]],
            imports: [
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"],
                _app_routing_module__WEBPACK_IMPORTED_MODULE_26__["AppRoutingModule"],
                _graphql_apollo_config__WEBPACK_IMPORTED_MODULE_15__["GraphQLModule"],
                components_menu_menu_module__WEBPACK_IMPORTED_MODULE_29__["MenuModule"],
                ...
                _modules_client_common_angular2_common_module__WEBPACK_IMPORTED_MODULE_12__["CommonModule"].forRoot({
                    apiUrl: _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVICES_ENDPOINT,
                }),
                _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"],
                _modules_client_common_angular2_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_22__["PipesModule"],
            ],
            bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_28__["AppComponent"]],
            entryComponents: [_app_component__WEBPACK_IMPORTED_MODULE_28__["AppComponent"]],
            providers: [
                _modules_client_common_angular2_services_server_connection_service__WEBPACK_IMPORTED_MODULE_24__["ServerConnectionService"],
                {
                    provide: _angular_core__WEBPACK_IMPORTED_MODULE_1__["APP_INITIALIZER"],
                    useFactory: serverConnectionFactory,
                    deps: [_modules_client_common_angular2_services_server_connection_service__WEBPACK_IMPORTED_MODULE_24__["ServerConnectionService"], _services_store_service__WEBPACK_IMPORTED_MODULE_23__["Store"]],
                    multi: true,
                },
                _modules_client_common_angular2_services_googleMapsLoader__WEBPACK_IMPORTED_MODULE_17__["GoogleMapsLoader"],
                {
                    provide: _angular_core__WEBPACK_IMPORTED_MODULE_1__["APP_INITIALIZER"],
                    useFactory: googleMapsLoaderFactory,
                    deps: [_modules_client_common_angular2_services_googleMapsLoader__WEBPACK_IMPORTED_MODULE_17__["GoogleMapsLoader"]],
                    multi: true,
                },
                _modules_client_common_angular2_services_maintenance_service__WEBPACK_IMPORTED_MODULE_19__["MaintenanceService"],
                {
                    provide: _angular_core__WEBPACK_IMPORTED_MODULE_1__["APP_INITIALIZER"],
                    useFactory: maintenanceFactory,
                    deps: [_modules_client_common_angular2_services_maintenance_service__WEBPACK_IMPORTED_MODULE_19__["MaintenanceService"]],
                    multi: true,
                },
                _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_4__["StatusBar"],
                _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"],
                _ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_6__["GoogleMaps"],
                { provide: _angular_router__WEBPACK_IMPORTED_MODULE_27__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_25__["IonicRouteStrategy"] },
                _ionic_native_google_analytics_ngx__WEBPACK_IMPORTED_MODULE_7__["GoogleAnalytics"],
                _ionic_native_mixpanel_ngx__WEBPACK_IMPORTED_MODULE_8__["Mixpanel"],
                ...
                _services_carriers_orders_service__WEBPACK_IMPORTED_MODULE_18__["CarriersOrdersService"],
                _ionic_native_vibration_ngx__WEBPACK_IMPORTED_MODULE_20__["Vibration"],
                _ionic_native_local_notifications_ngx__WEBPACK_IMPORTED_MODULE_21__["LocalNotifications"],
                _services_store_service__WEBPACK_IMPORTED_MODULE_23__["Store"],
            ],
        }),
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])
    ], AppModule);
...
function googleMapsLoaderFactory(provider) {
    return function () { return provider.load(_environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].GOOGLE_MAPS_API_KEY); };
}
function maintenanceFactory(provider) {
    return function () {
        return provider.load(_environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"]['SETTINGS_APP_TYPE'], _environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"]['SETTINGS_MAINTENANCE_API_URL']);
    };
}
function serverConnectionFactory(provider, store) {
    return function () { return provider.load(_environments_environment__WEBPACK_IMPORTED_MODULE_16__["environment"].SERVICES_ENDPOINT, store); };
}


/***/ }),

/***/ "./src/app/info/info.module.guard.ts":
/*!*******************************************!*\
  !*** ./src/app/info/info.module.guard.ts ***!
  \*******************************************/
...
var InfoModuleGuard = (function () {
    function InfoModuleGuard(router, store) {
        this.router = router;
        this.store = store;
    }
    InfoModuleGuard.prototype.canLoad = function (route) {
        var showInformationPage = this.store.showInformationPage;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("ion-menu ion-title {\n  text-align: center;\n}\n\nion-menu ion-item-divider {\n  visibility: visible;\n}\n\nion-menu ion-item-divider ion-icon {\n  margin-right: 10px;\n}\n\nion-menu ion-item {\n  visibility: visible;\n}\n\nion-menu ion-item ion-icon {\n  color: black;\n  margin-right: 15px;\n}\n\nion-menu ion-header {\n  position: relative;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
var MenuComponent = (function () {
    function MenuComponent(store) {
        this.store = store;
        this.companyName = environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].APP_NAME;
    }
    Object.defineProperty(MenuComponent.prototype, "showInformationPage", {
        get: function () {
            return this.store.showInformationPage;
        },
        enumerable: true,
...
var environment = {
    ...
    FAKE_UUID: '4b21ceb8-2e80-4083-bbb5-59f6507c02e4',
    MIXPANEL_API_KEY: '',
    DEFAULT_CUSTOMER_LOGO: 'http://res.cloudinary.com/evereq/image/upload/v1536843011/everbie-products-images/btzn3o8pimhercepno2d.png',
    LOGIN_LOGO: 'assets/imgs/DolceGrocery-logo.svg',
    NO_INTERNET_LOGO: 'assets/imgs/DolceGrocery-logo.svg',
    COMPANY_NAME: 'Ever Co. LTD',
    APP_NAME: 'Ever® Carrier',
...
var GraphQLModule = (function () {
    function GraphQLModule(apollo, httpLink) {
        var uri = _environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].GQL_ENDPOINT;
    ...
    GraphQLModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        ...
        Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [apollo_angular__WEBPACK_IMPORTED_MODULE_3__["Apollo"], apollo_angular_link_http__WEBPACK_IMPORTED_MODULE_4__["HttpLink"]])
    ], GraphQLModule);
...
var PagesModuleGuard = (function () {
    ...
    PagesModuleGuard.prototype.canLoad = function (route) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var showInformationPage;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        showInformationPage = this.store.showInformationPage;
                        if (!showInformationPage) return [3, 2];
                        return [4, this.router.navigateByUrl('/info')];
                    case 1:
                        _a.sent();
                        return [2, false];
...
/***/ "./src/services/carriers-orders.service.ts":
/*!*************************************************!*\
  !*** ./src/services/carriers-orders.service.ts ***!
  \*************************************************/
/*! exports provided: CarriersOrdersService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CarriersOrdersService", function() { return CarriersOrdersService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var CarriersOrdersService = (function () {
    function CarriersOrdersService(_apollo) {
        this._apollo = _apollo;
    }
    CarriersOrdersService.prototype.getCarrierOrders = function (carrierId, options) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var res;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        res = _a.sent();
                        return [2, res.data.getCarrierOrders];
                }
            });
        });
    };
    CarriersOrdersService.ctorParameters = function () { return [
        { type: apollo_angular__WEBPACK_IMPORTED_MODULE_2__["Apollo"] }
    ]; };
    CarriersOrdersService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(),
...
var Store = (function () {
    function Store(carrierRouter, translate) {
        this.carrierRouter = carrierRouter;
        this.translate = translate;
        this.selectedOrder$ = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"](this.selectedOrder);
    }
    Object.defineProperty(Store.prototype, "selectedOrder", {
        get: function () {
    ...
    Object.defineProperty(Store.prototype, "carrierId", {
        get: function () {
    ...
    Object.defineProperty(Store.prototype, "noInternet", {
        get: function () {
    ...
    Object.defineProperty(Store.prototype, "showInformationPage", {
        get: function () {
    ...
    Object.defineProperty(Store.prototype, "returnProductFrom", {
        get: function () {
    ...
    Object.defineProperty(Store.prototype, "driveToWarehouseFrom", {
        get: function () {
    ...
    Store.prototype.isLogged = function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var carrierId, error_1;
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        carrierId = this.carrierId;
                        if (!carrierId) return [3, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
    ...
    Store.prototype.clearNoInternet = function () {
...
module.exports = __webpack_require__(/*! /home/itexpert/Documents/DolceGrocery/packages/carrier-mobile-ionic/src/main.ts */"./src/main.ts");
